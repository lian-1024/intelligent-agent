...
//     //     {children}
//     // </div>
//     <Bubble className={className} content={content}>
...
//                 }
//             >
//                 <MessageBubble className={bubbleClassName} content={content}/>
//             </FollowerPointerCard>
//         </div>
//     );
// };
...
import { Bubble as BubbleX, BubbleProps as BubblePropsX } from '@ant-design/x'
import { FC } from 'react'


interface BubbleProps {
    content: BubblePropsX['content'],
    placement: BubblePropsX['placement']
}
const Bubble: FC<BubblePropsX> = (props) => {
    return <BubbleX className="bg-gray-900"
      {...props}
    />
}
